...
#ifndef ROTARYSWITCHTYPE_H
#define ROTARYSWITCHTYPE_H

#include <QObject>
#include "MdiWindowType.h"

class RotarySwitchType : public MdiWindowType {
    Q_OBJECT
public:
    explicit RotarySwitchType(QObject *parent = nullptr);
    ~RotarySwitchType() Q_DECL_OVERRIDE;
